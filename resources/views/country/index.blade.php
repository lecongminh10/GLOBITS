                    ...
                    <div class="listjs-table" id="customerList">
                        ...
                        <div class="table-responsive table-card mt-3 mb-1">
                            ...
                            <x-molecules.table :classTable="'table align-middle table-nowrap'" :idTable="'customerTable'">
                                <x-slot name="theah">
                                    <x-atoms.table_head :idClassThead="'table-light'" :headers="['STT', 'Code', 'Name', 'Description', 'Action']" />
                                </x-slot>
                                <x-slot name="tbody">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary" data-bs-toggle="modal" id="create-btn"
                                                    data-id="{{ $country->id }}" data-bs-target="#showModalEdit"><i
                        ...
                        <x-molecules.pagination :paginator="$countries"/>
                    </div>
                </div>
            </div>
        </div>
