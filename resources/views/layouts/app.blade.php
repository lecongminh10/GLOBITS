                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            {{-- <div class="collapse menu-dropdown" id="sidebarDashboards">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="/admin/categories" class="nav-link" data-key="t-analytics">Category</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/admin/posts" class="nav-link" data-key="t-api-key">Post</a>
                                    </li>
                                </ul>
                            </div> --}}
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                  <li class="nav-item">
                                    <a href="/country" class="nav-link" data-key="t-country">Country</a>
                                  </li>
                                    <li class="nav-item">
                                        <a href="/person" class="nav-link" data-key="t-person">Person</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/user" class="nav-link" data-key="t-user">User</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/role" class="nav-link" data-key="t-role">Role</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/company" class="nav-link" data-key="t-company">Company</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/project" class="nav-link" data-key="t-project">Project</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/task" class="nav-link" data-key="t-task">Task</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
